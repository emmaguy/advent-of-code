...
class Day3KtTest {
    ...
    @Test
    fun `example1, correct number of steps`() {
        val wire1 = listOf("R8", "U5", "L5", "D3")
        val wire2 = listOf("U7", "R6", "D4", "L4")

        assertEquals(30, calculateSteps(wire1 = wire1, wire2 = wire2))
    }

    @Test
    fun `example2, correct number of steps`() {
        val wire1 = listOf("R75", "D30", "R83", "U83", "L12", "D49", "R71", "U7", "L72")
        val wire2 = listOf("U62", "R66", "U55", "R34", "D71", "R55", "D58", "R83")

        assertEquals(610, calculateSteps(wire1 = wire1, wire2 = wire2))
    }

    @Test
    fun `example3, correct number of steps`() {
        val wire1 = listOf("R98", "U47", "R26", "D63", "R33", "U87", "L62", "D20", "R33", "U53", "R51")
        val wire2 = listOf("U98", "R91", "D20", "R16", "D67", "R40", "U7", "R15", "U6", "R7")

        assertEquals(410, calculateSteps(wire1 = wire1, wire2 = wire2))
    }

    @Test
    fun `input for santa, correct number of steps`() {
        ...
        assertEquals(35194, calculateSteps(wire1 = wire1, wire2 = wire2))
    }
}